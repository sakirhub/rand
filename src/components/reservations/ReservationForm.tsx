...
import { CalendarIcon, Clock, User, ImagePlus, X, PlusCircle } from "lucide-react";
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <Select onValueChange={field.onChange} defaultValue={field.value} disabled={timeSlots.length === 0 || isLoadingTimeSlots}>
                  <FormControl>
                    <SelectTrigger>
