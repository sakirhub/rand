        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-3 gap-4 p-4 bg-muted rounded-lg">
            ...
            <div>
              ...
              <div className="text-lg font-semibold text-green-600">{totalPaid.toLocaleString('tr-TR')} ₺</div>
            </div>
            <div>
              <div className="text-sm text-muted-foreground">Kalan</div>
              <div className="text-lg font-semibold text-yellow-600">{remainingAmount.toLocaleString('tr-TR')} ₺</div>
            </div>
          </div>
