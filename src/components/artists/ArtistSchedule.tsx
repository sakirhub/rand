  ...
  return (
    <Card>
                ...
                <TableRow>
                  ...
                  {weekDays.map(day => (
                    <TableHead key={day.toISOString()} className="text-center min-w-[100px]">
                      ...
                      <div className="text-sm font-normal">{format(day, "dd MMM", { locale: tr })}</div>
                    </TableHead>
                  ))}
                </TableRow>
              </TableHeader>
      ...
      <CardFooter className="flex justify-between text-sm text-muted-foreground">
        <div>
          <span className="inline-block w-3 h-3 bg-green-100 dark:bg-green-900/20 mr-1 rounded-sm"></span> Müsait
        </div>
        <div>
          <span className="inline-block w-3 h-3 bg-red-100 dark:bg-red-900/20 mr-1 rounded-sm"></span> Rezerve
        </div>
        <div>
          <span className="inline-block w-3 h-3 bg-gray-100 dark:bg-gray-800/50 mr-1 rounded-sm"></span> Kapalı
        </div>
      </CardFooter>
    </Card>
  );
