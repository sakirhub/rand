    ...
    useEffect(() => {
        ...
        `);
            ...
            if (error) {
                ...
                // Rezervasyon fotoğraflarını kontrol et
                if (data && data.length > 0) {
                    data.forEach((reservation, index) => {
                        console.log(`Rezervasyon ${index} (${reservation.id}) fotoğrafları:`, reservation.reservation_images);
                        
                        // Eğer reservation_images yoksa veya boşsa, image_url'yi kontrol et
                        if (!reservation.reservation_images || reservation.reservation_images.length === 0) {
                            if (reservation.image_url) {
                                console.log(`Rezervasyon ${index} için image_url bulundu:`, reservation.image_url);
                                // Eski format için uyumluluk sağla
